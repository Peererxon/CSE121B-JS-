...
function makeBody(status, race, nombre, location, origin) {
  function addStatusClass(circleElement, element) {
    switch (status) {
      case "Alive":
        circleElement.classList = "status__circle status__circle--green";
        break;

      case "Dead":
        circleElement.classList = "status__circle status__circle--red";
        break;

      case "unknown":
        circleElement.classList = "status__circle status__circle--gray";
        break;
      default:
        circleElement.classList = "status__circle status__circle--gray";
        break;
